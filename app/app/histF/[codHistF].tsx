...
import { buscarPedidoHistoricoFuncionario } from '@/constants/storage';
import { Pedido } from '@/constants/types';

const HistPedidoFuncionario: React.FC = () => {
    ...
    useEffect(() => {
        const loadPedido = async () => {
            if (data && hora) {
                const fetchedPedido = await buscarPedidoHistoricoFuncionario(data as string, hora as string);
            ...
            <KeyboardAvoidingView style={styles.keyboardAvoidingView} behavior="padding">
                <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    <View style={styles.headerPedido}>
                        <Text style={styles.headerPedidoText}>ID: {pedido.id}</Text>
...
export default HistPedidoFuncionario;
